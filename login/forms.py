...
class ConfiguracionForm(forms.Form):
    ...
    noti_creacion_proyecto = forms.BooleanField(help_text="Notificacion de proyectos creados")
    noti_creacion_usuario = forms.BooleanField(help_text="Notificacion de usuarios creados")
    noti_creacion_equipos = forms.BooleanField(help_text="Notificacion de equipos creados")
